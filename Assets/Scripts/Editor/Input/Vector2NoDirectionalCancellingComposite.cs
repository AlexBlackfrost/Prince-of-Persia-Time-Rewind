...
namespace UnityEngine.InputSystem.Composites {
    ...
    public class Vector2NoDirectionalCancellingComposite : InputBindingComposite<Vector2> {
        /// <summary>
        ...
        private float lastLeft, lastRight, lastUp, lastDown;
        private bool lastLeftIsPressed, lastRightIsPressed, lastUpIsPressed, lastDownIsPressed;
        ...
        public override Vector2 ReadValue(ref InputBindingCompositeContext context) {
            ...
            if (mode == Mode.Analog) {
                ...
                if (leftValue > 0 && lastRight != 0) {
                    leftValue = 0;
                }

                if(rightValue > 0 && lastLeft != 0) {
                    rightValue = 0;
                }

                if (upValue > 0 && lastDown != 0) {
                    upValue = 0;
                }

                if (downValue > 0 && lastUp != 0) {
                    downValue = 0;
                }
            ...
            if(leftIsPressed && rightIsPressed && lastRightIsPressed) {
                leftIsPressed = false;
            }

            if(rightIsPressed && leftIsPressed && lastLeftIsPressed) {
                rightIsPressed = false;
            }

            if(upIsPressed && downIsPressed && lastDownIsPressed) {
                upIsPressed = false;
            }

            if(downIsPressed && upIsPressed && lastUpIsPressed) {
                downIsPressed = false;
            }

            lastLeftIsPressed = leftIsPressed;
            lastRightIsPressed = rightIsPressed;
            lastUpIsPressed = upIsPressed;
            lastDownIsPressed = downIsPressed;
            /*Debug.Log("Last left: " + lastLeftIsPressed +
                          "  Last right: " + lastRightIsPressed +
                          "  CurrentLeft: " + leftIsPressed +
                          "  CurrentRight: " + rightIsPressed);*/
