...
public class HFSMTest {
    ...
    public void ZeroOneABChangeBState() {
        ...
        zeroStateMachine.AddTransition(oneStateMachine, BState, ()=> { return doTransitionOneB; });
    ...
    public void ZeroOneABCChangeCCState() {
        ...
        zeroStateMachine.AddTransition(oneStateMachine, CState, () => { return doTransitionOneC; });
    ...
    public void ZeroOneAUpdate() {
        ...
        oneStateMachine.AddTransition(AState, BState, () => { return doTransitionAB; });
    ...
    public void ThreeLevelTransition() {
        ...
        bool doTransitionAB = false;
        twoStateMachine.AddTransition(AState, BState, () => { return doTransitionAB; });
